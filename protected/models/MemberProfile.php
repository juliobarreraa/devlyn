...
class MemberProfile extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('picture, picture_thumb, curriculum', 'length', 'max'=>100),
			array('biography, extra_info', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, member_id, picture, picture_thumb, curriculum, biography, extra_info', 'safe', 'on'=>'search'),
		);
	}
