 ...
 * @since 1.0
 */
class RedisSession extends CHttpSession
{
    ...
    */
    public function openSession($savePath,$sessionName) {
        $this->lifetime = 3600*24*30; // 30 days;
        return true;
    }
	...
	{
		foreach(Yii::app()->session->getIterator() as $key => $value) {
			$_SESSION[$key] = $value;
		}

		$_SESSION['keyPrefix'] = Yii::app()->user->getStateKeyPrefix();
