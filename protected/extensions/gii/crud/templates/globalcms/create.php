...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon edit"></i><span class="break"></span><?php echo "<?php echo Yii::t('adminModule.".strtolower($this->class2name($this->modelClass))."','Crear Nuevo " . $this->class2name($this->modelClass) . "') ?> " ?> </h2>
			<div class="box-icon">
