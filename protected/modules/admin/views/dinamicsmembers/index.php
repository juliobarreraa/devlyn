...
$this->breadcrumbs=array(
	Yii::t('adminModule.Dynamics Members', 'Dynamics Members'),
);
...
<div class="row-fluid">
	...
	<div class="row-fluid">
		<div class="span12">
			<h3 class="header smaller lighter blue"><?php echo Yii::t('adminModule.Dynamics Members', 'Dynamics Members') ?></h3>
						...
						<th class="center">
							<label>
								...
								<span class="lbl"></span>
																								...
																								<th><?php echo Yii::t('adminModule.Dynamics Members', 'ID') ?></th>
																		<th><?php echo Yii::t('adminModule.Dynamics Members', 'Miembro') ?></th>
																		<th><?php echo Yii::t('adminModule.Dynamics Members', 'ID Dinámica') ?></th>
																		<th><?php echo Yii::t('adminModule.Dynamics Members', 'Respuesta') ?></th>
																		<th><?php echo Yii::t('adminModule.Dynamics Members', 'Actualizado el') ?></th>
																		<th><?php echo Yii::t('adminModule.Dynamics Members', 'Creado el') ?></th>
																		<th></th>
					</tr>
				</thead>
