...
$this->breadcrumbs=array(
	Yii::t('adminModule.Resources', 'Resources'),
);
...
<div class="row-fluid">
	...
	<div class="row-fluid">
		<div class="span12">
			<h3 class="header smaller lighter blue"><?php echo Yii::t('adminModule.Resources', 'Recursos') ?></h3>
			<?php echo CHtml::link(Yii::t('adminModule.Resources','Crear nuevo recurso'),array('resources/create')); ?>
						...
						<th class="center">
							<label>
								...
								<span class="lbl"></span>
																		...
																		<th><?php echo Yii::t('adminModule.Resources', 'ID') ?></th>
																		<th><?php echo Yii::t('adminModule.Resources', 'Nombre') ?></th>
																		<th><?php echo Yii::t('adminModule.Resources', 'Actualizado el') ?></th>
																		<th><?php echo Yii::t('adminModule.Resources', 'Creado el') ?></th>
																		<th></th>
					</tr>
				</thead>
