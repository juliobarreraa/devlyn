...
$this->breadcrumbs=array(
	Yii::t('adminModule.settings', 'Panel de Configuración'),
);
...
<div class="row-fluid">
	...
	<div class="row-fluid">
		<div class="span12">
			<h3 class="header smaller lighter blue"><?php echo Yii::t('adminModule.settings', 'Panel de configuración') ?></h3>
			<table id="table_report" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th><?php echo Yii::t('adminModule.settings', 'Aplicación') ?></th>
						<th><?php echo Yii::t('adminModule.settings', 'Última actualización') ?></th>
						<th></th>
					</tr>
				</thead>
				...
				<tbody>
					<?php foreach ($dataProvider->getData() as $key => $value): ?>					<tr>
						...
						<td>	
							<?php echo CHtml::link(CHtml::encode($value->name), array('view', 'id'=>$value->id)); ?>
						</td>
