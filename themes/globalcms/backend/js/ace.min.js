...
jQuery(function($) {
	...
	if (CKEDITOR.replace !== "object") {
		CKEDITOR.replace('ckeditorBrowserContent', {
			filebrowserBrowseUrl: gcms.baseUrl + "/js/ckeditor/filemanager/browser/default/browser.html?Connector=" + gcms.baseUrl + "/admin/resources/connector",
			filebrowserImageBrowseUrl: gcms.baseUrl + "/js/ckeditor/filemanager/browser/default/browser.html?Connector=" + gcms.baseUrl + "/admin/resources/connector?Type=File",
			filebrowserFlashBrowseUrl: gcms.baseUrl + "/js/ckeditor/filemanager/browser/default/browser.html?Connector=" + gcms.baseUrl + "/admin/resources/connector?Type=Image",
			filebrowserFlashBrowseUrl: gcms.baseUrl + "/js/ckeditor/filemanager/browser/default/browser.html?Connector=" + gcms.baseUrl + "/admin/resources/connector?Type=Flash",
		});

		CKEDITOR.replace('ckeditorBrowserInstructions', {
			filebrowserBrowseUrl: gcms.baseUrl + "/js/ckeditor/filemanager/browser/default/browser.html?Connector=" + gcms.baseUrl + "/admin/resources/connector",
			filebrowserImageBrowseUrl: gcms.baseUrl + "/js/ckeditor/filemanager/browser/default/browser.html?Connector=" + gcms.baseUrl + "/admin/resources/connector?Type=File",
			filebrowserFlashBrowseUrl: gcms.baseUrl + "/js/ckeditor/filemanager/browser/default/browser.html?Connector=" + gcms.baseUrl + "/admin/resources/connector?Type=Image",
			filebrowserFlashBrowseUrl: gcms.baseUrl + "/js/ckeditor/filemanager/browser/default/browser.html?Connector=" + gcms.baseUrl + "/admin/resources/connector?Type=Flash",
